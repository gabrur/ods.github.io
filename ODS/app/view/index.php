...
<head>
  ...
  <title>LMGV - Lutando por um mundo melhor</title>
</head>
...
<body>
  <header id="header">
    ...
    <nav class="navbar">
      ...
      <div id="entrarr" class="menu">
        <?php if (!isset($_SESSION['id']) || $_SESSION['grupo_id'] == 3): ?>
  ...
  <div id="cookieup" class="cookie">
    <p>Utilizamos cookies para melhorar sua experiência em nosso site. Ao continuar navegando, você concorda com nossa <a href="politica.php">Política de Privacidade</a>.</p>
    <button id="recusascookies">recusar</button>
    <button id="aceitascookies" type="submit">Aceitar</button>
  </div>
