...
<body>
    ...
    <section class="corpo">
        ...
        <canvas id="graficoods1" width="400" height="190"></canvas> <br><br>
        <canvas id="graficoods1.2" width="400" height="190"></canvas> <br><br>
        <canvas id="graficoods1.3" width="400" height="190"></canvas> <br><br>
        <canvas id="graficoods1.4" width="400" height="190"></canvas>
